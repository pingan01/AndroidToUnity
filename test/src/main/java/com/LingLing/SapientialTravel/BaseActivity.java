...
public class BaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    protected NaviLatLng mEndLatlng = new NaviLatLng(34.216549, 108.89237);
    protected NaviLatLng mStartLatlng = new NaviLatLng(34.217502, 108.888481);
...
//        mAMapNavi.stopNavi();
    ...
    public void onCalculateRouteFailure(int errorInfo) {
        //路线计算失败
        Toast.makeText(this, "errorInfo：" + errorInfo + ",Message：" + errorInfo, Toast.LENGTH_LONG).show();
    }
